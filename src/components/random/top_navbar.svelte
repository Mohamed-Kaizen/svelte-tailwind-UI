<nav
	class="w-full h-16 lg:h-12 p-4 flex items-center justify-center
	lg:justify-end bg-gray-700 text-white">

	<div>

		<a
			class="flex items-center text-xs hover:text-blue-500"
			href="https://github.com/Mohamed-Kaizen/svelte-tailwind-UI/"
			target="blank">

			<svg class="h-8 w-8 fill-current mr-2" viewBox="0 0 480 512">
				<path
					fill="currentColor"
			...
			<span>Mohamed-Kaizen/svelte-tailwind-UI</span>
