		...
		<span class="hover:text-pink-500 cursor-pointer mr-3">
			...
			<svg viewBox="0 0 512 512" class="h-5 w-5 fill-current">
				<path
					...
					44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208
					208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7
					99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4
					9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7
					57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128
					128z"></path>
			</svg>
		</span>
	...
	<button
		...
		<svg class="h-5 w-5 fill-current mr-1" viewBox="0 0 24 24">
			<path
				...
				012-2h3v2H6v12h12V9h-3V7h3a2 2 0 012 2v12a2 2 0 01-2 2z"></path>
		</svg>
		<span>Export</span>
	</button>
		...
		<button
			...
			<svg class="h-5 w-5 fill-current" viewBox="0 0 24 24">
				<path
					...
					0l-2.01-2.01a.989.989 0 01-.29-.83V12h-.03L4.21 4.62a1 1 0
					01.17-1.4c.19-.14.4-.22.62-.22h14c.22 0 .43.08.62.22a1 1 0
					01.17 1.4L14.03 12H14z"></path>
			</svg>
		</button>
		<button
		...
		<button
			...
			<svg class="h-5 w-5 fill-current" viewBox="0 0 24 24">
				<path
					...
					10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4z"></path>
			</svg>
		</button>
	</div>
</div>
