<nav class="flex flex-col bg-gray-200 w-64 px-12 pt-4 pb-6">
	...
	<div class="flex flex-row border-b items-center justify-between pb-2">
		<!-- Hearder -->
		<span class="text-lg font-semibold capitalize">my admin</span>

		<span class="relative ">
			<a class="hover:text-green-500 text-gray-600" href="inbox/">
				<svg
					width="24"
					height="24"
					viewBox="0 0 24 24"
			...
			<div
				class="absolute w-2 h-2 rounded-full bg-green-500 right-0 mb-5
				bottom-0"></div>
		</span>
	...
	<div class="mt-8">
		...
		<h2 class="mt-4 text-xl font-extrabold capitalize">Hello Enoshima</h2>
		<span class="text-sm ">
	...
	<ul class="mt-2 text-gray-600">
		...
		<li class="mt-8">
			<a href="#home" class="flex ">
				<svg class="fill-current h-5 w-5" viewBox="0 0 24 24">
					<path
						d="M16 20h4v-4h-4m0-2h4v-4h-4m-6-2h4V4h-4m6 4h4V4h-4m-6
						10h4v-4h-4m-6 4h4v-4H4m0 10h4v-4H4m6 4h4v-4h-4M4
						8h4V4H4v4z"></path>
				</svg>
			...
			<a href="#home" class="flex pl-4">
				<svg class="fill-current h-5 w-5" viewBox="0 0 24 24">
					<path
						...
						014-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4z"></path>
				</svg>
		...
		<li class="mt-8">
			<a href="#home" class="flex">
				<svg class="fill-current h-5 w-5" viewBox="0 0 24 24">
					<path
						d="M12 13H7v5h5v2H5V10h2v1h5v2M8 4v2H4V4h4m2-2H2v6h8V2m10
						9v2h-4v-2h4m2-2h-8v6h8V9m-2 9v2h-4v-2h4m2-2h-8v6h8v-6z"></path>
				</svg>
				<span class="ml-2 capitalize font-medium text-black">tasks</span>
			</a>
		</li>
